...
public class Bunny4 implements ActionListener {
		...
		public Bunny4(int[] tablicaWarunkow, int nrPoziomu, ImageIcon zmianaKolorow, ImageIcon koniecLevelu) {
		...
		public void actionPerformed(ActionEvent a) {
			if(a.getSource()==doMenu) {
				Levels twojeLevele4=new Levels();
				ramka.setVisible(false);
				twojeLevele4.pokazLevele();
			}
			// zawsze();
			if (a.getSource() == przycisk) {
				...
				if (drugiKrolikKolor == kroliki.length)
					drugiKrolikKolor = 0;
				Krolik2();
				pierwszyKrolikKolor+=2;
				if (pierwszyKrolikKolor >= kroliki.length)
					pierwszyKrolikKolor=pierwszyKrolikKolor%kroliki.length;
				Krolik1();
				PierwszaPlansza();
				if(Wykonane()) {
				...
				trzeciKrolikKolor+=2;
				if (trzeciKrolikKolor >= kroliki.length)
					trzeciKrolikKolor = trzeciKrolikKolor%kroliki.length;
				Krolik3();
				PierwszaPlansza();
				if(Wykonane()) {
...
//			gra.PierwszaPlansza();
		...
		public void PierwszaPlansza() {
			...
			kroliki[6] = "data/fairPinkBunny.jpg";
			kroliki[7] = "data/fairBunny.jpg";
