...
public class Bunny3 implements ActionListener{
		...
		int pierwszyKrolikKolor = 1;
		JButton trzeciKrolik = new JButton();
		int drugiKrolikKolor = 2;
		JButton czwartyKrolik = new JButton();
		int trzeciKrolikKolor = 3;
		JButton drugiKrolik = new JButton();
		int czwartyKrolikKolor = 4;

		public Bunny3(int[] tablicaWarunkow, int nrPoziomu, ImageIcon zmianaKolorow, ImageIcon koniecLevelu) {
		...
		public void actionPerformed(ActionEvent a) {
			if(a.getSource()==doMenu) {
				Levels twojeLevele3=new Levels();
				ramka.setVisible(false);
				twojeLevele3.pokazLevele();
			}
			// zawsze();
