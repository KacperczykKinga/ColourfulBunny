...
public class Bunny7 implements ActionListener{
	...
	public Bunny7(int[] tablicaWarunkow, int nrPoziomu, ImageIcon zmianaKolorow, ImageIcon koniecLevelu) {
	...
	public void actionPerformed(ActionEvent a) {
		if(a.getSource()==doMenu) {
			Levels twojeLevele7=new Levels();
			ramka.setVisible(false);
			twojeLevele7.pokazLevele();
		}
		// zawsze();
		if (a.getSource() == przycisk) {
			...
			drugiKrolikKolor+=2;
			if (drugiKrolikKolor >= kroliki.length)
				drugiKrolikKolor = drugiKrolikKolor%kroliki.length;
			Krolik2();
			PierwszaPlansza();
			if(Wykonane()) {
