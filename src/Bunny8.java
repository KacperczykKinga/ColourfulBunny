...
public class Bunny8 implements ActionListener{
	...
	public Bunny8(int[] tablicaWarunkow, int nrPoziomu, ImageIcon zmianaKolorow, ImageIcon koniecLevelu) {
	...
	public void actionPerformed(ActionEvent a) {
		if(a.getSource()==doMenu) {
			Levels twojeLevele8=new Levels();
			ramka.setVisible(false);
			twojeLevele8.pokazLevele();
		}
		// zawsze();
...
//		gra.PierwszaPlansza();
	...
	public void PierwszaPlansza() {
		...
		kroliki[0] = "data/orangeBunny.jpg";
		kroliki[1] = "data/darkRedBunny.jpg";
		kroliki[2] = "data/BlueBunny.jpg";
		kroliki[3] = "data/fairPinkBunny.jpg";
		kroliki[4] = "data/fairBunny.jpg";
		kroliki[5] = "data/YellowBunny.jpg";
