...
public class Bunny2 implements ActionListener{
		...
		public Bunny2(int[] tablicaWarunkow, int nrPoziomu, ImageIcon zmianaKolorow, ImageIcon koniecLevelu) {
		...
		public void actionPerformed(ActionEvent a) {
			if(a.getSource()==doMenu) {
				Levels twojeLevele2=new Levels();
				ramka.setVisible(false);
				twojeLevele2.pokazLevele();
			}
			// zawsze();
			...
			/*	if (Wykonane()) {
					/*
					 * panelGlowny.remove(trzeciKrolik); panelGlowny.remove(czwartyKrolik);
					 * 
					 * JPanel panelGlowny=new JPanel(); JLabel napis=new JLabel("Wygra³eœ!");
					 * ramka.getContentPane().add(BorderLayout.CENTER, panelGlowny);
					 * ramka.repaint(); //koniec.getContentPane().add(BorderLayout.CENTER, wynik);
					 * //koniec.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
					 * panelGlowny.add(napis);
					 */
					/*System.out.println("tak dzia³am");
					PierwszaPlansza();
					Wygrana();
		...
		public void Wygrana()  {
			// JFrame koniec=new JFrame();
			// panelGlowny.remove(panelPierwszejPlanszy);
			// panelGlowny.remove(panelPierwszejPlanszyA);
			// JPanel panelGlowny=new JPanel();
			...
			trzeciKrolik = null;
			czwartyKrolik = null;
			/*JLabel napis = new JLabel("Wygra³eœ!");
			Informacje.remove(poziom);
			Informacje.remove(ruchy);
			Informacje.add(napis);
			// ramka.repaint();
			ramka.getContentPane().add(BorderLayout.CENTER, panelGlowny);
			// koniec.getContentPane().add(BorderLayout.CENTER, wynik);
			// koniec.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			Informacje.add(napis);*/
...
//			gra.PierwszaPlansza();
		...
		public void PierwszaPlansza() {
			...
			kroliki[4] = "data/darkRedBunny.jpg";
			kroliki[5] = "data/BlueBunny.jpg";
