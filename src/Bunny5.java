...
public class Bunny5 implements ActionListener {
		...
		public Bunny5(int[] tablicaWarunkow, int nrPoziomu, ImageIcon zmianaKolorow, ImageIcon koniecLevelu) {
		...
		public void actionPerformed(ActionEvent a) {
			if(a.getSource()==doMenu) {
				Levels twojeLevele5=new Levels();
				ramka.setVisible(false);
				twojeLevele5.pokazLevele();
			}
			// zawsze();
